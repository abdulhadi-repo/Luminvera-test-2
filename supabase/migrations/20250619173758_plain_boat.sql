/*
  ...
  1. Sample Categories
    ...
    - Handle conflicts on both id and slug columns
...
-- Insert sample categories with proper conflict handling on slug
...
-- Insert sample products with proper conflict handling on slug
